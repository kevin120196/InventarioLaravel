    ...
    <div class="row">
        <div class="formulario" style="box-shadow: none; padding:3px;">
            <div class="cabeceraForm">
                <h1>Reportes de Inventario de Compras</h1>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12" id="excel" style="display: none">
                    <div class="input-contenedor input-30 input-100" style="border: none;">
                        <a href="{{route('admin.reportes.excelReporteCompra')}}" class="button-primary"><i class="fa fa-print"></i> Reporte General</a>
                    </div>
                    {!! Form::open(['id'=>'inputcodigo2','route'=>'admin.reportes.excelReporteCompra','method'=>'GET']) !!}
                    <div class="input-contenedor input-30 input-100 buscar-input">
                        <i class="fa fa-search icon"></i> 
                        {!! Form::number('codigo', null, ['placeholder'=>'N° Factura']) !!}
                    </div>
                    ...
                    {!! Form::open(['id'=>'inputbuscar2','route'=>'admin.reportes.excelReporteCompra','method'=>'GET','style'=>'display:none']) !!}
                    <div class="input-contenedor input-30 input-100 buscar-input" >
                        <i class="fa fa-search icon"></i>
                    ...
                    {!! Form::open(['id'=>'inputestante2','route'=>'admin.reportes.excelReporteCompra','method'=>'GET','style'=>'display:none']) !!}
                    <div class="input-contenedor input-30 input-100 buscar-input" >
                        <i class="fa fa-search icon"></i> 
                        <input type="text" name="estado" id="estado" placeholder="Estados Factura">
                    </div>
                    ...
                    {!! Form::close() !!}
                    {!! Form::open(['id'=>'inputinvervalos2','route'=>'admin.reportes.excelReporteCompra','method'=>'GET','style'=>'display:none']) !!}
                    <div class="input-contenedor input-30 input-100 buscar-input" >
                        <i class="fa fa-search icon"></i> 
                        <input type="date" name="inicio" id="inicio" placeholder="Inicio">
                        
                    {!! Form::open(['id'=>'inputinvervalos12','route'=>'admin.reportes.excelReporteCompra','method'=>'GET','style'=>'display:none']) !!}
