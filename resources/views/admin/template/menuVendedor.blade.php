<nav class="menu">
    <ul>
        ...
        <li><i><img src="{{asset('img/compras.png')}}" alt=""></i> <a>Compras</a>
            <ul>
                <li><i class="material-icons">library_add</i><a href="{{route('compras.create')}}"> Nueva Compra</a></li>
                <li><i><img src="{{asset('img/Factura.png')}}" alt=""></i> <a href="{{route('compras.index')}}"> Detalles Compras</a></li>
            </ul>
        </li>
        ...
        <li><i><img src="{{asset('img/camion-de-reparto.png')}}" alt=""></i> <a>Ventas</a>
            <ul>
                <li><i class="material-icons">library_add</i><a href="{{ route('venta.create')}}"> Nueva Venta</a></li>
                <li><i><img src="{{asset('img/Factura.png')}}" alt=""></i> <a href="{{route('venta.index')}}"> Detalles Ventas</a></li>
            </ul>
        </li>
        <li id="user">                    
